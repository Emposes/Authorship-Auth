...
#Train model
num_epochs = 10
BiLSTM = model.fit(train_padded, training_author_seq, epochs=num_epochs, validation_data=(validation_padded, validation_author_seq), verbose=2)
...
#Train model
num_epochs = 10
BiLSTM_word_vec = model.fit(train_padded, training_author_seq, epochs=num_epochs, validation_data=(validation_padded, validation_author_seq), verbose=2)
    
#Plot training metrics for model evaluation
plot_graphs(BiLSTM_word_vec, "accuracy")
plot_graphs(BiLSTM_word_vec, "loss")    